import { AroundTheUsData as Data } from "@/data/data";
import { Modal } from "./ui/Modal";
import PNW from "../public/Us.png";
import { Button } from "./ui/Button";

export const ModalTwo = ({ closeModal }: { closeModal?: () => void }) => {
  return (
    <Modal className="p-0">
      <div className="flex flex-col gap-4 max-w-[420px] bg-[#2b2b2b] p-5 z-10">
        <div className="flex flex-col gap-4">
          <div className="pt-3 bg-[#2b2b2b] flex flex-col gap-2">
            <img alt={Data.alt} src={PNW.src} className="rounded-2xl w-full" />
          </div>
